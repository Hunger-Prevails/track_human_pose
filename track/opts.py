...
parser.add_argument('-channels', default=512, type=int, help='Number of convolution channels')
parser.add_argument('-root_channels', default=64, type=int, help='Number of convolution channels for the root branch')
parser.add_argument('-inflation', default=3, type=int, help='inflation rate of dilation among convolutions')
...
# float options
parser.add_argument('-zeta', default=0.5, type=float, help='zeta for determining the frequency of procedural noice')
...
parser.add_argument('-learn_rate', default=2e-5, type=float, help='Base learning rate for train')
