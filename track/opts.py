...
parser.add_argument('-sigma_root_xy', default=2.0, type=float, help='sigma for normal sampling on root-xy jitter')
parser.add_argument('-sigma_root_zz', default=5.0, type=float, help='sigma for normal sampling on root-zz jitter')
